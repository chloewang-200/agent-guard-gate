...
const Admin = () => {
  ...
  const [isAuthed, setIsAuthed] = useState(() => localStorage.getItem(authKey) === "true");
      ...
      <div className="min-h-screen bg-slate-50 px-6 py-24 flex items-center justify-center">
        <div className="mx-auto w-full max-w-md rounded-xl border border-slate-900 bg-white p-8 shadow-[2px_2px_0_0_rgba(0,0,0,1)]">
          <div className="flex items-center gap-2 mb-6">
            <img src="/logo.png" alt="Custos" className="h-8 w-8" />
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button 
              type="submit" 
              className="w-full border border-slate-900 shadow-[2px_2px_0_0_rgba(0,0,0,1)] font-semibold"
  ...
  return (
    <div className="min-h-screen bg-slate-50 px-6 py-16">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Button 
              onClick={loadRows} 
              disabled={isLoading}
              className="border border-slate-900 shadow-[2px_2px_0_0_rgba(0,0,0,1)] font-semibold bg-white hover:bg-slate-50"
            >
        ...
        <div className="rounded-xl border border-slate-900 bg-white shadow-[2px_2px_0_0_rgba(0,0,0,1)] overflow-hidden">
          <Table>
            <TableHeader>
              <TableRow className="hover:bg-slate-50/70 border-b border-slate-900">
            ...
            <TableBody>
              {rows.map((row) => (
                <TableRow key={`${row.email}-${row.createdAt ?? "na"}`} className="hover:bg-slate-50/70 border-b border-slate-200">
