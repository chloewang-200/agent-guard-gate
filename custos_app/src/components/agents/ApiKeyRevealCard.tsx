...
import { isAgentApiKeyFeatureEnabledClient } from "@/lib/features";

interface ApiKeyRevealCardProps {
  agentId: string;
}

const apiKeyFeatureEnabled = isAgentApiKeyFeatureEnabledClient();
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-caption text-muted-foreground">
            Agent API keys are not enabled for this deployment yet.
          </p>
        </CardHeader>
      </Card>
    );
